...
namespace sl
{
	...
	public class ZEDCamera
    {
		...
		/// </summary>
		public static readonly System.Version PluginVersion = new System.Version(2, 3, 1);
        ...
        */
        ...
        private static extern int dllz_check_plugin();
        ...
        public static bool CheckPlugin()
        {
            ...
            catch (DllNotFoundException)
            {
                ...
                //string errorMessage = ZEDLogMessage.Error2Str(ZEDLogMessage.ERROR.SDK_DEPENDENCIES_ISSUE);
                return false;
        ...
        public ERROR_CODE Init(ref InitParameters initParameters)
        {
            ...
            currentResolution = sl.RESOLUTION.HD720;
        ...
        /// <returns></returns>
        public TRACKING_FRAME_STATE GetPosition(ref Pose pose, REFERENCE_FRAME referenceType = REFERENCE_FRAME.WORLD)
        {
            return (TRACKING_FRAME_STATE)dllz_get_position_data(ref pose, (int)referenceType);
        }
        ...
        public void ReshapeChunks(int numberFaces, int[] nbVerticesInSubemeshes, int[] nbTrianglesInSubemeshes, ref int nbSubmeshes, int[] updatedIndices, ref int nbVertices, ref int nbTriangles, int nbSubmesh)
        {
