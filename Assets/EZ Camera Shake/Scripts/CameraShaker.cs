...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        private Vector3 InitLocalPos, InitLocalRot;
        ...
        void Awake()
        {
            ...
            InitLocalRot = transform.rotation.eulerAngles;
        }
        ...
        void Update()
        {
            ...
            transform.localPosition =InitLocalPos + posAddShake;
            transform.localEulerAngles = InitLocalRot + rotAddShake;
        }
